...
const HowItWorks = ({ onGoalSelect }: HowItWorksProps) => {
  ...
  return (
    <section id="how" className="pt-2 pb-8 md:pt-10 md:pb-36 px-6">
          ...
          {goals.map((goal, i) => {
            ...
            return (
              <button
                ...
                className={`group relative text-left transition-all duration-200 w-full max-w-[640px] mx-auto ${offsetClass}`}
                style={{
                  aspectRatio: "3 / 4",
                  borderRadius: "20px",
                  background: cardBg,
